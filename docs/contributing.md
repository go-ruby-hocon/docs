...
Contributions are welcome. `go-ruby-hocon/hocon` is built to a small set of
...
The library is in [`github.com/go-ruby-hocon/hocon`](https://github.com/go-ruby-hocon/hocon).
This documentation site is in [`github.com/go-ruby-hocon/docs`](https://github.com/go-ruby-hocon/docs).
