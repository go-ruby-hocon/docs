# go-ruby-hocon documentation

**Ruby HOCON adapter over the pure-Go go-hocon engine (CGO=0).**

`go-ruby-hocon/hocon` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `hocon`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-hocon/hocon`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `hocon`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`hocon`](https://github.com/go-ruby-hocon/hocon) | the library — Ruby's `hocon` in pure Go |
| [`docs`](https://github.com/go-ruby-hocon/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-hocon.github.io`](https://github.com/go-ruby-hocon/go-ruby-hocon.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-hocon/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-hocon/hocon](https://github.com/go-ruby-hocon/hocon).
